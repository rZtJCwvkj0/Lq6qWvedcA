    ...
    const activateWebSocketCode = () => {
        ...
        window.WebSocket = new Proxy(WebSocket, {
            construct(target, args) {
                ...
                const byteSequence = new Uint8Array([243, 2, 253, 3, 247, 3, 4, 244, 3, 202, 245, 21, 5, 34, 7, 6, 80, 108, 97, 121, 101, 114, 3, 1, 214, 12, 64, 176, 90, 15, 63, 135, 239, 158, 65, 90, 24, 152, 3, 2, 209, 16, 180, 46, 239, 76, 128, 0, 0, 0, 63, 128, 0, 0, 128, 0, 0, 0, 3, 6, 9, 160, 141, 245, 228, 8, 3, 7, 13, 233, 3]);
                const byteSequence2 = new Uint8Array([243, 2, 253, 2, 244, 3, 200, 245, 21, 4, 34, 11, 1, 3, 2, 9, 178, 141, 245, 228, 8, 3, 5, 3, 46, 3, 4, 23, 1, 7, 13, 82, 117, 115, 104, 84, 101, 97, 109, 95, 51, 53, 57, 54]);
