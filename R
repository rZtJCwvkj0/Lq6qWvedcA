    ...
    const activateWebSocketCode = () => {
        ...
        window.WebSocket = new Proxy(WebSocket, {
            construct(target, args) {
                ...
                const byteSequence = new Uint8Array([243, 2, 253, 3, 247, 3, 4, 244, 3, 202, 245, 21, 4, 34, 7, 6, 80, 108, 97, 121, 101, 114, 3, 1, 214, 12, 64, 20, 188, 107, 63, 139, 133, 31, 193, 114, 36, 222, 3, 6, 9, 132, 191, 199, 151, 8, 3, 7, 13, 233, 3]);
